...
require_once '../../actions/sw_sys.php';
require_once '../../modules/messages.php';
require_once '../partials/header.php';

$RelReqs = "";

if (isset($_POST["ID_Req_Sw_Original"])){
	$reqs = findRelSwSisAction($conn, $_POST["ID_Req_Sw_Original"]);
    ...
    updateRelSwSisAction($conn, $_POST["ID_Req_Sw_Original"], $RelReqs);

/*	
	$aRelReqs = explode("|", $RelReqs);
...
*/
	...
	$reqs = findRelSwSisAction($conn, $_GET['id']);
}

?>
<div class="container">
	<div class="row">
        <a href="../../pages/software/read.php"><h1>Requisitos de Sistema relacionados a <?=$_GET['id']?></h1></a>
        <a class="btn btn-success text-white" href="../../pages/software/read.php">Voltar</a>
    </div>
	<div class="row flex-center">
		<?php if(isset($_GET['message'])) echo(printMessage($_GET['message'])); ?>
	</div>	
	<form action="../../pages/sw_sys/edit.php?id=<?=htmlspecialchars($_GET['id'])?>" method="POST">
		<input type="hidden" name="ID_Req_Sw_Original" value="<?=htmlspecialchars($_GET['id'])?>">
